...
public class BeanMarkdownDoclet extends AbstractBeanDoclet {
   ...
   * @param childInSection the child in section
   * @throws IOException the iO exception
   */
  @Override
  protected void writeClassSection(ClassTree classTree, ClassDoc classDoc, boolean childInSection) throws IOException {
